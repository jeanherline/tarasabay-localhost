        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Onboarding Requirements</li>
                </ol>
                <hr>
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" autocomplete="on" enctype="multipart/form-data">
                            <div id="emailHelp" class="form-text">
                                ...
                                ?>
                                    <em style="color: green;"><b>Update: </b>You already submitted a Registration</em>
                                <?php
                                }
                                ?><br><br>
                            ...
                            <div id="pwdDetailsContainer" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="disabilityType" name="disabilityType" required>
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $driver_license_front = $_FILES['driver_license_front']['name'];
                                $driver_license_back = $_FILES['driver_license_back']['name'];
                                ...
                                $nbi_police_cbi_photo = $_FILES['nbi_police_cibi_photo']['name'];
                                $pwdID = $_FILES['pwdID']['name'];
                                ...
                                // Insert into the driver_identification table
                                ...
                                $stmt = $db->prepare("INSERT INTO driver_identification (user_id, pwd_docx, license_front, license_back, license_expiration, is_above_60, nbi_police_cbi, years_experience, disability) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
                                $stmt->bind_param("issssisss", $user_id, $pwdID, $driver_license_front, $driver_license_back, $license_expiration, $is_above_60, $nbi_police_cbi, $years_experience, $otherDisability);
                                $stmt->execute();
                                ...
                                try {
                                    ...
                                    $mail->Body = "
                                                ...
                                                <p>If you haven't already done so, please log in to the TaraSabay App and navigate to the car registration section. Follow the instructions provided to complete the process.</p>
                            ...
                            <button type="submit" style="float:right; margin-right: 1%;" name="submit" id="submit" class="btn btn-success">Submit Registration</button>
