                    ...
                    <div class="card-body">
                        <form method="POST" autocomplete="on" enctype="multipart/form-data">
                            <div id="emailHelp" class="form-text">
                                ...
                                ?><br>
                                    <em style="color: green;"><b>Status Update: </b>You already submitted your Driver Onboarding Form</em>
                                    <br><br>
                                    ...
                                    <?php
                                    $user_id = $_SESSION['user_id'];
                                    $query = "SELECT * FROM driver_identification WHERE user_id = $user_id AND driver_stat = 'Approved'";
                                    $result = mysqli_query($db, $query);
                                    ...
                                    ?>
                                        <br>
                                        <em style="color: green;"><b>Status Update: </b>Please check your license expiration, it seems to have expired.<br>
                                            Submit the following requirements to the nearest TaraSabay office in <b><?php echo $_SESSION['city_name']; ?></b> :</em>
                                        <br> <br>
                                        • Photocopy of Driver's License <br>
                                        ...
                                        <br>
                                        By fulfilling these requirements, you can ensure the smooth continuation of your TaraSabay driver account.
                                        <br>
