                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                            $ret = "SELECT DISTINCT COALESCE(up.first_name, 'N/A') AS passenger_first_name, up.last_name, s.seat_type, s.fare, s.seat_status, b.user_id AS passenger_user_id
                                                    FROM seat s
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if ($row['seat_status'] === 'Available') {
                                                    echo "<td>N/A</td>";
                                                } elseif ($row['passenger_first_name'] && $row['last_name']) {
                                                    echo '<td><a href="viewPassenger.php?user_id=' . $row['passenger_user_id'] . '&list=' . $list . '">' . $row['passenger_first_name'] . ' ' . $row['last_name'] . '</a></td>';
                                                } else {
                                                    echo "<td>N/A</td>";
                                                }
