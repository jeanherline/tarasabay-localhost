                  ...
                  if ($db->query($sql) === TRUE) {
                    ...
                    try {
                      ...
                      $mail->Body = "
                          ...
                          <p><a href=\"http://localhost/tarasabay/verify.php?token=" . urlencode($token) . " \" style=\"display:inline-block; padding: 10px 20px; background-color: #0072C6; color: #fff; font-weight: bold; text-decoration: none;\">Verify Your Email Address</a></p>
